view: payments {
  ...
  dimension: partials_test_ind {
    ...
    sql: CASE
      WHEN ${payment_method} = 'ACH'
        AND (${payment_scheduled_for_date} between '2024-07-09' and '2024-07-25' or
          ${payment_scheduled_for_date} between '2024-08-14' and '2024-08-27')
  ...
  measure: ever_rescheduled_rate {
    type: number
    sql: ${ever_rescheduled_payments}/NULLIF(${initiated_ach_payments},0) ;;
    value_format_name: percent_1
  }
